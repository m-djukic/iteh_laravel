    ...
    <div class="container-fluid mt-4 " id="create-form">
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://itechment.com/wp-content/uploads/2017/07/c34102da-9849-11e5-b4f4-1b7a09ed2cea.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="indexNumber" type="text" class="form-control"  placeholder="Enter index number">
                            </div>
                            <div class="form-group">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update/'.$student->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label>Index Number</label>
                                <input value="{{ $student->indexNumber }}" name="indexNumber" type="text" class="form-control"  placeholder="Enter index number">
                            </div>
                            <div class="form-group">
                                <label>First Name</label>
